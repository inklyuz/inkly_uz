  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
      <header className="border-b border-[#E8E3DD] pb-8">
        <p className="text-xs font-semibold uppercase tracking-widest text-[#6B7280]">Jamiyat</p>
        <h1 className="mt-2 text-4xl font-extrabold tracking-tighter text-[#141414] sm:text-5xl">Ijodkorlar</h1>
        <p className="mt-4 max-w-xl leading-relaxed text-pretty text-[#36565F]">
      ...
      <section aria-label="Ijodkorlar ro'yxati" className="py-10">
        {creatorsPage.items.length === 0 ? (
          <p className="py-16 text-center text-[#6B7280]">Hozircha ijodkorlar yo&apos;q</p>
        ) : (
      ...
      <section className="rounded-2xl bg-[#141414] px-6 py-12 text-center sm:px-12">
        <h2 className="text-2xl font-bold tracking-tight text-balance text-white sm:text-3xl">
          Siz ham ijodkor bo&apos;ling
        </h2>
        <p className="mx-auto mt-3 max-w-md leading-relaxed text-pretty text-white/70">
