...
export default async function CreatorsPage({
   ...
   */
  const postsPage = await listPostsSafe({
    page,
    page_size: 50,
        ...
        <div className="grid grid-cols-1 gap-8 xl:grid-cols-[minmax(0,1fr)_290px]">
          ...
          <section className="min-w-0">
            ...
            <header>
              ...
              <p className="mt-2 text-[14px] leading-6 text-[#626A75]">
                Inkly&apos;da fikr ulashayotgan yozuvchilar bilan tanishing.
              </p>
            </header>
            ...
            <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              >
                ...
                <Search
                  size={17}
                  strokeWidth={1.8}
                  className="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 text-[#65707C]"
                />
        ...
        return (
          <div
            ...
            className={[
              ...
              index > 0
                ? "border-l border-[#EEE9E3]"
                : "",
              index >= 2
                ? "border-t border-[#EEE9E3] sm:border-t-0"
                : "",
            ].join(" ")}
          >
            <Icon
            ...
            <div>
              <div className="text-[17px] font-bold tracking-[-0.02em] text-[#202020]">
                {item.value}
              </div>

              <div className="mt-0.5 text-[11px] text-[#68717B]">
                {item.label}
              </div>
            </div>
          </div>
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-0.5 truncate text-[11px] text-[#69727C]">
            @{creator.username}
          </p>
        </div>
      </div>
      ...
      {/* Description */}
      <p className="mt-4 min-h-[40px] text-[12px] leading-5 text-[#252525]">
        {creator.description ||
          creator.bio ||
      ...
      <div className="mt-auto pt-4">
        <div className="grid grid-cols-3 gap-2">
          ...
          <Metric
            icon={Eye}
            value={formatNumber(creator.views || 0)}
            label="O'qish"
          />

          <Metric
            icon={Heart}
            value={formatNumber(creator.likes || 0)}
            label="Yoqtirish"
          />
        </div>
  ...
  return (
    <div className="min-w-0">
      <div className="flex items-center gap-1.5">
        ...
        <span className="truncate text-[11px] font-medium text-[#252525]">
          {value}
        </span>
      </div>

      <p className="mt-1 text-[10px] text-[#747B83]">
        {label}
      </p>
    </div>
  )
      ...
      <div className="mt-4">
        <label className="flex cursor-pointer items-start gap-2">
          ...
          <span>
            ...
            <span className="mt-1 block text-[10px] leading-4 text-[#747B83]">
  ...
  return (
    ...
    >
      ...
      <div className="mt-5 flex flex-col items-center text-center">
        ...
        <h3 className="mt-3 text-[14px] font-bold text-[#191919]">
          {creator.full_name}
        </h3>
...
function EmptyCreators({
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-[12px] text-[#77736D]">
        {search
