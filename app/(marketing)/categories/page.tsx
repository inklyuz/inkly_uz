...
export default async function CategoriesPage() {
  ...
  return (
    <main className="min-h-[calc(100vh-74px)] bg-[#FCFBF9]">
...
function CategoriesHeader({
  ...
  return (
    <header className="border-b border-[#E7E2DC] pb-7">
      <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <h1 className="mt-2 text-[32px] font-bold tracking-[-0.04em] text-[#171717] sm:text-[38px]">
            Kategoriyalar
          </h1>

          <p className="mt-2 max-w-xl text-[14px] leading-6 text-[#77736D]">
            O‘zingizga qiziq mavzuni tanlang va shu yo‘nalishdagi
            maqolalarni kashf qiling.
          </p>
        </div>

        <div className="flex shrink-0 items-center gap-2 text-[13px] text-[#77736D]">
...
function CategoryItem({
  ...
  return (
    <Link
      ...
      className="group border-b border-[#E7E2DC] py-7 pr-6 transition-colors sm:nth-[2n]:pl-6 sm:nth-[2n]:pr-0 lg:nth-[2n]:pl-0 lg:nth-[3n+2]:px-6 lg:nth-[3n]:pl-6 lg:nth-[3n]:pr-0"
    >
        ...
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            {category.description && (
              <p className="mt-2 line-clamp-2 text-[13px] leading-5 text-[#77736D]">
                {category.description}
              </p>
            )}
          </div>
...
function EmptyState() {
  return (
    <section className="border-b border-[#E7E2DC] py-24 text-center">
