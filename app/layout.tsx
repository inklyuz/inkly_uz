...
// Editorial display typeface — globals.css references this via
// --font-display: var(--font-playfair), Georgia, serif.
// It was previously never loaded, so every --font-display usage
// (hero title, post cards, section headings) silently fell back
// to the Georgia system font.
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="uz" className={`${poppins.variable} ${sora.variable} ${playfair.variable} bg-white`}>
