...
export function Youtube({ size = 16, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M23.5 6.7a3.02 3.02 0 0 0-2.12-2.14C19.51 4 12 4 12 4s-7.51 0-9.38.56A3.02 3.02 0 0 0 .5 6.7 31.6 31.6 0 0 0 0 12a31.6 31.6 0 0 0 .5 5.3 3.02 3.02 0 0 0 2.12 2.14C4.49 20 12 20 12 20s7.51 0 9.38-.56a3.02 3.02 0 0 0 2.12-2.14A31.6 31.6 0 0 0 24 12a31.6 31.6 0 0 0-.5-5.3ZM9.6 15.6V8.4L15.8 12l-6.2 3.6Z" />
    </svg>
  )
}