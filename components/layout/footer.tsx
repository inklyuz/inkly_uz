              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="flex h-9 w-9 items-center justify-center rounded-full text-[#303030] transition-all duration-200 hover:bg-[#FFF0E7] hover:text-[#FF6A00]"
                  >
                    <Icon />
                  </a>
                )
                ...
                <div className="mt-5 flex flex-col gap-3.5">
                  {column.links.map((link) => (
                    <Link
                      ...
                      href={link.href}
                      className="w-fit text-[12px] text-[#68645F] transition-colors hover:text-[#FF6A00]"
                    >
                      {link.label}
                    </Link>
                  ))}
