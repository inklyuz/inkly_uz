...
/** GET /users/check javobi — validate_username() rad etsa ham 200 bilan qaytadi. */
...
export const usersApi = {
  ...
  checkUsername: (username: string) =>
    apiRequest<UsernameCheckResponse>(
      `/users/check?username=${encodeURIComponent(username.replace(/^@/, ""))}`,
    ),
