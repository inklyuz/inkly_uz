...
export const postListItemSchema = z.object({
  ...
  cover: z.string().nullable(),
  status: z.enum(["draft", "scheduled", "publishing", "published", "failed", "archived"]),
  ...
  publish_attempts: z.number().int().nonnegative().default(0),
  last_publish_error: z.string().nullable().default(null),
})
